...
const Cover = () => {
  ...
  return (
    <div className="flex w-[100%] gap-[30px] h-fit">
      <div className="w-[20%]">
        <h6 className="text-[20px] font-semibold">Ảnh bìa</h6>
      </div>
      ...
      <div className="w-[80%] ">
        <div className="flex gap-[30px]">
          <div className="flex-1">
            <div>
              <label className="label-text ">Thêm ảnh bìa (*)</label>
            </div>
